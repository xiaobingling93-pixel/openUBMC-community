...
2、无法修复的漏洞需要在安全sig组评审备案（包括业界无解决方案的CVE漏洞），并给出合理的规避方案

3、如果判断发布的CVE对代码无影响，需给出合理解释并到安全sig组评审备案，备案通过后可不用修改
...
（若扫描结果中有漏洞未修复，开发组需要进行修复或说明无法修复原因到安全sig组评审备案）
...
扫描结果中无安全编码问题遗留，如有不满足项需没出合理解释并到安全sig组评审
...
（若扫描结果中有安全编译选项未应用，开发组需要进行修改，评估不适合修改的，准备材料到安全sig组评审备案）
