...
* 请参考[Gitcode用户指南](https://docs.gitcode.com/docs/start/quick)注册GitCode账户，并在[用户设置](https://gitcode.com/setting/email)中设置您的主邮箱。
...
* 参与社区宣传推广与内容制作，事件/技术/课程/视频请投稿至[tc@public.openubmc.cn](mailto:tc@public.openubmc.cn)；
